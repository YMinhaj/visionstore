<?php 
include '../included/brand/connection.php';
include '../included/brand/brandfunc.php';
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <!-- search form -->
      <?php include '../menu/menucategory.php';?>
      <!-- /.search form -->
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="../included/category/categoryfunc.php" method="POST" enctype="multipart/form-data">
              <div class="box-body">
...
Name: <input type=text class="form-control" name="add" >
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Select brand Inside Category</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
              <form method ="POST" action ="../included/category/category_brand.php">
...
?>  
              ...
              <!-- /.form-group -->
            <button type="submit" class="btn btn-success" name='addcatbrand' >Submit</button>
...
<div class="box">
            ...
            <div class="box-header">
              <h3 class="box-title">All Category with Brands</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
?>  
                ...
                <tr>
                  ...
                  <td>
                       ...
                       <?php
$query1 = "Select * from category_brand where cat_id=".$key['id'];
$sql1 = $conn->query($query1);
$data1 = $sql1->fetchAll();
foreach ($data1 as $k ) {
  # code...
  $query11 = "Select * from brand where id=".$k['brand_id'];
$sql11 = $conn->query($query11);
$data11 = $sql11->fetchAll();
 foreach ($data11 as $k1 ) {
echo $k1['name']." , ";
