...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <!-- search form -->
      <?php include '../menu/menuslider.php';?>
      <!-- /.search form -->
  ...
  <div class="content-wrapper">
   ...
   <div class="box-body">
              <div class="callout callout-danger">
                ...
                <p>Please Upload a Slider Image  of Approximately Atleast 640 X 380 Size in any image format type with a White background </p>
              </div>
              </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="../included/slider/sliderfunc.php" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">

                <div class="form-group">
                  <label for="exampleInputFile"> Image input</label>
                  <input type="file" id="exampleInputFile" name="slider">

                  <p class="help-block">When you clicked submit button your Slider will be replaced but you can download previous one and set again.</p>
                </div>
                    <div class="box">
...
<div class="box">
            <div class="box-header">
              <h3 class="box-title">Uploaded banners</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
