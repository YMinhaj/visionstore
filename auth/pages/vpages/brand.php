...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <!-- search form -->
      <?php include '../menu/menubrand.php';?>
      <!-- /.search form -->
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="../included/brand/brandfunc.php" method="POST" enctype="multipart/form-data">
              <div class="box-body">
...
MENS/WOMANS/LENSE CATEGORY: 
                ...
                <div class="form-group">
                  ...
                  <p class="help-block">When you clicked submit button your logo will be replaced but you can download previous one and set again.</p>
                </div>
...
?>  
                ...
                <tr>
                  ...
                  <td><?php echo "<a class='btn btn-danger' href='../included/brand/delbrand.php?id=".$key{'id'}."'> Delete</a>";?> <?php echo "<a class='btn btn-warning' href='../included/brand/check.php?id=".$key{'id'}."'> Update</a>";?></td>
                </tr>
                              <?php
                    }
